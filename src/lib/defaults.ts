...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        'Hospital de la Fundación Hernández Zurita en Orizaba. Nueva cara digital del hospital: servicios, quirófano y membresías T-Médica con fotografía real de sus áreas. En construcción.',
      tags: ['Hospital · Próximamente', 'Servicios', 'T-Médica'],
